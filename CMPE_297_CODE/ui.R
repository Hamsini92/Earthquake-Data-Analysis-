...
body <- dashboardBody(
              ...
              column(width=12,
                     box(#title="Select time window",
                         ...
                         dateRangeInput("daterange", "Select date range:",
                                        start = "2014-01-01", #"2015-04-12",
                                        end   = "2017-12-03", #"2016-05-29",
                                        min = "2014-01-01",  #"2015-04-12",
                                        max = "2017-12-03"), #"2016-05-29"),
                         actionButton("updateButton", "Update graphs")
                         # verbatimTextOutput("adf")
                         )),
              column(width=12,
                     box(title='United States Quake timeline', solidHeader=TRUE,
            ...
            fluidRow(
              column(width = 12,
                     ...
                     #box(width = NULL, solidHeader = TRUE,
                         ...
                         #br(),
                         box(title='Fatalities and injuries from Different Quakes', solidHeader=TRUE,
                             background = "black",
                             width = NULL,
                             collapsible = TRUE,
            ...
            tabPanel("Fatalities, injuries and damage", #tabPanel 2
                     fluidRow(
                       column(width=12,
                              ...
                              box(title = "California Earthquake official fatalities, injuries and damage figures", solidHeader=TRUE,
                                  width = 12, collapsible=FALSE,
  ...
  tabItem(tabName ="Predictions",
          fluidRow(
            column(width = 12,
                       box(title='Prediction Plot', solidHeader=TRUE,
                           background = "black",
                           width = NULL,
                           collapsible = TRUE,
